...
export default function catalog(){
  ...
  var h1s = $("#markdown-body").find("h1");
  var h2s = $("#markdown-body").find("h2");
  var h3s = $("#markdown-body").find("h3");
  var h4s = $("#markdown-body").find("h4");
  var h5s = $("#markdown-body").find("h5");
  var h6s = $("#markdown-body").find("h6");
  ...
  $("#markdown-catalog").prepend('<div class="BlogAnchor">' +
    '<p>' +
